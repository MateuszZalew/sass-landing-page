  ...
  return (
    <section className="hero-section text-center mt-32 flex flex-col">
      ...
      <h1 className="text-4xl font-extrabold leading-[1.15] text-black sm:text-6xl">
        Launch Your Sass
        <br />
        <span className="bg-gradient-to-r from-pink-500 via-indigo-600 to-pink-500 bg-clip-text text-4xl font-extrabold leading-[1.15] text-transparent sm:text-6xl">
          In Minutes Not Days
        </span>
      </h1>
